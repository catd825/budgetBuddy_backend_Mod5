...
# Transaction.create(bank_account_id: BankAccount.all.second.id, category_id: Category.all[0].id, category_name: Category.all[0].name, amount: -1000, date: Date.new(2020,8,30), month: 8, description: "Rent", trans_type: "Expense", user_id: User.all.second.id)
