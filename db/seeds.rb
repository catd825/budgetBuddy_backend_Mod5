...
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[0].id, category_name: Category.all[0].name, amount: 2000.00, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[1].id, category_name: Category.all[1].name, amount: 200.00, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[2].id, category_name: Category.all[2].name, amount: 150.00, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[3].id, category_name: Category.all[3].name, amount: 100.00, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[4].id, category_name: Category.all[4].name, amount: 120.00, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[5].id, category_name: Category.all[5].name, amount: 300.00, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[6].id, category_name: Category.all[6].name, amount: 300.00, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[7].id, category_name: Category.all[7].name, amount: 0, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[8].id, category_name: Category.all[8].name, amount: 0, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[9].id, category_name: Category.all[9].name, amount: 0, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[10].id, category_name: Category.all[10].name, amount: 0, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Expense")
UserCategory.create(user_id: User.all.first.id, user_name: User.all.first.name, category_id: Category.all[11].id, category_name: Category.all[11].name, amount: -3170, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), trans_type: "Income")
...
Transaction.create(bank_account_id: BankAccount.all.sample.id, category_id: Category.all[11].id, category_name: Category.all[11].name, amount: 3170, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), description: "Paycheck", trans_type: "Income")
...
Transaction.create(bank_account_id: BankAccount.all.sample.id, category_id: Category.all[10].id, category_name: Category.all[10].name, amount: -50, date: Faker::Date.between(from: '2020-09-30', to: '2020-09-30'), description: "ACLU", trans_type: "Expense")
